    ...
    tabItems(
      ...
      tabItem(tabName = "tab2",
              ...
              fluidRow({
                box(
                  ...
                  , status = "primary", solidHeader = TRUE,width = '100%',collapsible = TRUE,collapsed=TRUE,
                    column(4,h6(HTML("<b>1.SABIC All \b")),actionButton("sall1","1.SABIC All",width = '100%')),
              ...
              fluidRow({
                box(
                  ...
                  box(
                    ...
                    , status = "primary", solidHeader = TRUE,width = '100%',collapsible = TRUE,collapsed = TRUE,
                    column(4,box(
                      title =HTML( '<font color=#ffffff> <font size="3">No change Head count</font></font>')
              ...
              fluidRow({
                ...
                box(
                  title =HTML( '<font color=#ffffff> <font size="5">Default Values</font></font>')
                  , status = "primary", solidHeader = TRUE,width = '100%',collapsible = TRUE,collapsed = TRUE,
              ...
              fluidRow(
                box(
                  ...
                  , status = "primary", solidHeader = TRUE,width = '100%',height = '450px',
                  tabBox(
                    ...
                    tabPanel("Automation",
                             {
                                          box(status = "primary", width = '100%',
                                              actionButton("reset_sdd","Reset")
                                              ,actionButton("save_sdd","Save"),
                                              # fluidRow(
                                              #   dataTableOutput(outputId = "tld")
                                              # ),
                                              fluidRow(
                                                column(2,br(),br(),h5('Total DD')),
                                                column(2,
                                                       textInput("t2sa1", h5("Year 1 Value"),
                                                                 value = ld$`T=1` #"1250"
                                                       )) ,
                                                column(2,
                                                       textInput("t2sa2", h5("Year 2 Value"),
                                                                 value = ld$`T=2` #"1250"
                                                       )) ,
                                                column(2,
                                                       textInput("t2sa3", h5("Year 3 Value"),
                                                                 value = ld$`T=3` #"1250"
                                                       )) ,
                                                column(2,
                                                       textInput("t2sa4", h5("Year 4 Value"),
                                                                 value = ld$`T=4` #"1250"
                                                       )) ,
                                                column(2,
                                                       textInput("t2sa5", h5("Year 5 Value"),
                                                                 value = ld$`T=5` #"1250"
                                                       ))
                                              )
...
server <- function(input, output,session) {
  ...
  observeEvent(input$sall1,{
    ...
    updatePickerInput(session, "uipname", selected = unique(db$`CF/SBU/AFF`[order(db$`CF/SBU/AFF Name`)]))
