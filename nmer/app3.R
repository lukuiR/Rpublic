    ...
    tabItems(
      ...
      tabItem(tabName = "tab2",
              ...
              fluidRow(
                box(
                  ...
                  p("All values are preloaded with the results of research and SABIC data. An average of these, weighted on
                    ...
                    style = "font-family: 'Source Sans Pro';"),
                  p("There are two types of parameter that can be adjusted: Macro Parameters, which apply to the whole organisation, and
              ...
              fluidRow(
                box(
                  ...
                  , status = "primary", solidHeader = TRUE,width = '100%',collapsible = TRUE,collapsed=TRUE,
                    column(4,h6("1.SABIC All"),actionButton("sall1","1.SABIC All",width = '100%')),
                    column(4, uiOutput('uityp')),column(4,uiOutput('uirg')),column(4,uiOutput('uiname')),
                    column(4, uiOutput('uidiv')),column(4,uiOutput('uijob')),column(4,uiOutput('uisjob'))
              ...
              fluidRow(
                box(
                  ...
                  box(
                    ...
                    ,status="warning",  solidHeader = TRUE,width = '100%',collapsible = TRUE,collapsed = TRUE, color="orange",
              ...
              fluidRow(
                ...
                box(
                  title =HTML( '<font color=#ffffff> <font size="4">Default Values</font></font>')
                  , status = "warning", solidHeader = TRUE,width = '100%',collapsible = TRUE,collapsed = TRUE,
                  fluidRow( 
              ...
              fluidRow(
                box(
                  title =HTML( '<font color=#ffffff> <font size="5">Default Parameters</font></font>')
                  , status = "primary", solidHeader = TRUE,width = '100%',height = '100%',
                  tabBox(
                    ...
                    tabPanel("Supply",
                             {
                               fluidRow(
                                 box(title=HTML( '<font color=#ffffff> <font size="4">Supply Rate Adjustments:</font></font>'), solidHeader = TRUE, status="primary",colour="light blue",
                                     width=12, height = "280px",
                                     fluidRow(
                                       actionButton("reset_shrk","Reset"),br(),
                                       actionButton("save_shrk","Save"),actionButton("reset_shrk","Reset Current Values"),
                                       tabBox(
                                         # The id lets us use input$tabset1 on the server to find the current tab
                                         id = "tabset1Y", width = '70%', height = "220px",
                                         tabPanel("Year 1",
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2skm1",label = "MEA NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$MEA[2]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2skap1",label = "APAC NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$APAC[2]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2ska1",label = "AMR NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$AMR[2]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2ske1",label = "EUR NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$EUR[2]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69"))
                                         ),
                                         tabPanel("Year 2",
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2skm2",label = "MEA NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$MEA[3]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2ska2",label = "APAC NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$APAC[3]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2skap2",label = "AMR NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$AMR[3]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2ske2",label = "EUR NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$EUR[3]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69"))
                                         ),
                                         tabPanel("Year 3",
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2skm3",label = "MEA NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$MEA[4]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2ska3",label = "APAC NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$APAC[4]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2skap3",label = "AMR NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$AMR[4]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2ske3",label = "EUR NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$EUR[4]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69"))
                                         ),
                                         tabPanel("Year 4",
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2skm4",label = "MEA NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$MEA[5]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2ska4",label = "APAC NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$APAC[5]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2skap1",label = "AMR NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$AMR[5]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2ske4",label = "EUR NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$EUR[5]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69"))
                                         ),
                                         tabPanel("Year 5",
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2skm5",label = "MEA NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$MEA[6]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2ska5",label = "APAC NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$APAC[6]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2skap5",label = "AMR NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$AMR[6]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69")),
                                                  column(3,
                                                         knobInput(
                                                           inputId = "t2ske5",label = "EUR NHR:",thickness=0.2, width=100, height=100,
                                                           value = nhr$EUR[6]*100,min = -100, max = 100, step = 0.1, displayPrevious = TRUE,lineCap = "round",
                                                           fgColor = "#42cb69",angleOffset = -135,angleArc=270,inputColor = "#42cb69"))
                                         )
                                       )
                                     )
                    ...
                    tabPanel("Demand",
                             {
                                          box(status = "primary", width = '100%',
                                              ...
                                              fluidRow(
                                                ...
                                                column(2,
                                                       textInput("t2sdd1", h5("Year 1 Value"),
                                                                 value = ld$`T=1` #"1250"
                                                       )) ,
                                                column(2,
                                                       textInput("t2sdd2", h5("Year 2 Value"),
                                                                 value = ld$`T=2` #"1250"
                                                       )) ,
                                                column(2,
                                                       textInput("t2sdd3", h5("Year 3 Value"),
                                                                 value = ld$`T=3` #"1250"
                                                       )) ,
                                                column(2,
                                                       textInput("t2sdd4", h5("Year 4 Value"),
                                                                 value = ld$`T=4` #"1250"
                                                       )) ,
                                                column(2,
                                                       textInput("t2sdd5", h5("Year 5 Value"),
                                                                 value = ld$`T=5` #"1250"
                                                       ))
                                              )
                    ...
                    tabPanel("Rightsizing Position",
                             {fluidRow(
                               box(
                                 ...
                                 , status = "primary", solidHeader = TRUE,width = '100%',collapsible = TRUE,collapsed = TRUE,
                                 column(4,box(
                                   title =HTML( '<font color=#ffffff> <font size="3">Default Current Head count</font></font>')
                                   , status = "primary", solidHeader = TRUE,width = '100%',
                                   h4("37k")
                                 )),
                                 column(4,box(
                               ...
                               box(status = "primary", width = '100%',
                                   actionButton("reset_b","Reset"),
                                   sliderInput("MEA2", "Headcount:",
                                               min = 0, max = 100,
                                               value = nhr$MEA[1]*100,pre = "%", step = 0.01, ticks = FALSE),
                                   actionButton("reset_bs","Save")
                               )
                             )
                             }
                             ),
                    tabPanel("L&D Investment",
                             {
                               box(status = "primary", width = '100%',
                                   actionButton("reset_sld","Reset z")
                                   ,actionButton("save_sld","Save"),
                                   # fluidRow(
                                   #   dataTableOutput(outputId = "tld")
                                   # ),
                                   fluidRow(
      ...
      tabItem(tabName = "tab3",
              ...
              fluidRow(
                box(width = 14,status = "primary",
                    column(12,actionButton("sall1","1. SABIC All",width = '50%'), align = "center"),
                    column(4,pickerInput("pType",label=HTML('<font color=#454545>Function/BU Type</font>'),choices=unique(db$`CF/SBU/AFF`[order(db$`CF/SBU/AFF`)]),
                                         selected=unique(db$`CF/SBU/AFF`),
                                         options = list( `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"
                                         ),  multiple = TRUE)),
                    column(4,pickerInput("prg",label=HTML('<font color=#454545>Region</font>'),choices=unique(db$Region[order(db$Region)]),selected = unique(db$Region),
                                         options = list(
                                           `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"),  multiple = TRUE)),
                    column(4,pickerInput("pName",label=HTML('<font color=#454545>Function/Affiliate Name</font>'),choices=unique(db$`CF/SBU/AFF Name`[order(db$`CF/SBU/AFF Name`)]),
                                         selected=unique(db$`CF/SBU/AFF Name`),
                                         options = list( `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3" ),  multiple = TRUE)),
                    column(4,pickerInput("pdiv",label='Org. Structure',choices=unique(db$Division[order(db$Division)]),selected = unique(db$Division), 
                                         options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"
                                         ), multiple = TRUE)),
                    column(4,pickerInput("pFamily",label=HTML('<font color=#454545>Job Family</font>'),choices=unique(db$Family[order(db$Family)]),selected=unique(db$Family),
                                         options = list( `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3" ),  multiple = TRUE)),
                    column(4,pickerInput("pSub",label=HTML('<font color=#454545>Job Sub-Family</font>'),choices=unique(db$`Sub Family`[order(db$`Sub Family`)]),
              ...
              fluidRow(
                column(4,pickerInput("p3emp",label=HTML('<font color=#454545>Employment</font>'),choices=c('Contractor','Direct Hire','NA'),
                                     selected=c('Contractor','Direct Hire','NA'),
                                     options = list( `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3" ),multiple = TRUE)),
                column(4,pickerInput("p3seg",label=HTML('<font color=#454545>Segment</font>'),choices=c('Core','Specialist','Support','Critical','Not Map'),
              ...
              fluidRow(
                box(status = "primary", width = 12, collapsible = TRUE,
                    h4('Workforce Journey'),
                    radioButtons("radio_t3", label = NULL,
              ...
              fluidRow(
                ...
                box(status = "primary", width = 12, collapsible = TRUE,
                    ...
                    label='asd', h4('Right Sizing Scenario Comparison'),
...
server <- function(input, output,session) {
  ...
  observeEvent(input$reset_shrk,{
    updateTextInput(session, "t2skm1", value = nhr$MEA[1]*100)
    updateTextInput(session, "t2skap1", value = nhr$APAC[1]*100)
    updateTextInput(session, "t2ska1", value = nhr$AMR[1]*100)
    updateTextInput(session, "t2ske1", value = nhr$EUR[1]*100)
    
    updateTextInput(session, "t2skm2", value = nhr$MEA[2]*100)
    updateTextInput(session, "t2skap2", value = nhr$APAC[2]*100)
    updateTextInput(session, "t2ska2", value = nhr$AMR[2]*100)
    updateTextInput(session, "t2ske2", value = nhr$EUR[2]*100)
  ...
  }#old sample
  {
    ...
    output$uityp = renderUI({
      pickerInput("uipType",label=HTML('<font color=#454545>2.Function/BU Type</font>'),choices=unique(db$`CF/SBU/AFF`[order(db$`CF/SBU/AFF`)]),
                  selected=unique(db$`CF/SBU/AFF`),
                  options = list( `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"
                  ),  multiple = TRUE)
    })
    output$uirg = renderUI({
      pickerInput("uiprg",label=HTML('<font color=#454545>3.Region</font>'),choices=outrg(),
                  selected=outrg(),
                  options = list( `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"
                  ),  multiple = TRUE)
    })
    ...
    output$uiname = renderUI({
      pickerInput("uipname",label=HTML('<font color=#454545>4.Function/Affiliate Name</font>'),choices=outnm(),
                selected= outnm(),
                options = list( `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3" ),  multiple = TRUE)
      })
    output$uidiv = renderUI({
      pickerInput("uipdiv",label=HTML('<font color=#454545>5.Org. Structure</font>'),choices=outdiv(),
                  selected= outdiv(),
                  options = list( `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3" ),  multiple = TRUE)
    })
    output$uijob = renderUI({
      pickerInput("uipjob",label=HTML('<font color=#454545>6.Job Family</font>'),choices=outjob(),
                  selected= outjob(),
                  options = list( `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3" ),  multiple = TRUE)
    })
    output$uisjob = renderUI({
      pickerInput("uipsjob",label=HTML('<font color=#454545>7.Job Sub Family</font>'),choices=outsjob(),
                  selected= outsjob(),
                  options = list( `actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3" ),  multiple = TRUE)
    })
  ...
  nms =sum(sign(aoc()$not_map)*aoc()$addt)
  revenue <-c(sum(aoc()$total), sum(sign(aoc()$Core)*aoc()$addt),sum(sign(aoc()$Specialist)*aoc()$addt),sum(sign(aoc()$Support)*aoc()$addt),sum(sign(aoc()$Critical)*aoc()$addt), nms)
  ...
  col=c('rgba(1,1,1, 0.0)',"darkorange3", "midnightblue", "gold2", "deepskyblue2", "gray64")
  nms =sum(sign(aoc()$not_map)*aoc()$subt)
  revenue <--c(-sum(aoc()$total)-sum(aoc()$addt)-sum(aoc()$subt), sum(sign(aoc()$Core)*aoc()$subt),sum(sign(aoc()$Specialist)*aoc()$subt),sum(sign(aoc()$Support)*aoc()$subt),sum(sign(aoc()$Critical)*aoc()$subt), nms)
  cat=c(rep(c('0.Base','1.Core','2.Specialist','3.Support','4.Critical','5.Not Map'),1))
  ...
  x <- c(rep('4.Y1 E',5))
  col=c("darkorange3", "midnightblue", "gold2", "deepskyblue2", "gray64")
  revenue <-c(sum(aoc()$Core)+sum(sign(aoc()$Core)*aoc()$subt)+sum(sign(aoc()$Core)*aoc()$addt),
              sum(aoc()$Specialist)+sum(sign(aoc()$Specialist)*aoc()$subt)+sum(sign(aoc()$Specialist)*aoc()$addt),
              sum(aoc()$Support)+sum(sign(aoc()$Support)*aoc()$subt)+sum(sign(aoc()$Support)*aoc()$addt) ,
              sum(aoc()$Critical)+sum(sign(aoc()$Critical)*aoc()$subt)+sum(sign(aoc()$Critical)*aoc()$addt), 
              sum(aoc()$not_map)+sum(sign(aoc()$not_map)*aoc()$subt)+sum(sign(aoc()$not_map)*aoc()$addt))
  cat=c(rep(c('1.Core','2.Specialist','3.Support','4.Critical','5.Not Map'),1))
  ...
  nma=sum(aoc()$sray23)-sum(aoc()$fte5)
  
  rasa <-c(0,sum(aoc()$Core)-sum(sign(aoc()$Core)*aoc()$subt)  ,  sum(aoc()$Specialist)-sum(sign(aoc()$Specialist)*aoc()$subt)  ,  sum(aoc()$Support)-sum(sign(aoc()$Support)*aoc()$subt)  ,  sum(aoc()$Critical)-sum(sign(aoc()$Critical)*aoc()$subt)  , 0)
  revenue <-c(-sum(aoc()$sray23), sum(sign(aoc()$Core)*aoc()$sray23),sum(sign(aoc()$Specialist)*aoc()$sray23),sum(sign(aoc()$Support)*aoc()$sray23),sum(sign(aoc()$Critical)*aoc()$sray23), 0)
  revenue <-rasa-revenue
  nma=sum(aoc()$sray23)-sum(aoc()$fte5)-sum(revenue[2:5])
  cat=c(rep(c('0.Base','1.Core','2.Specialist','3.Support','4.Critical','5.Not Map'),1))
  ...
  col=c('rgba(1,1,1, 0.0)',"darkorange3", "midnightblue", "gold2", "deepskyblue2", "gray64")
  nmf =sum(aoc()$fte5)-(sum(sign(aoc()$Core)*aoc()$fte5) + sum(sign(aoc()$Specialist)*aoc()$fte5) + sum(sign(aoc()$Support)*aoc()$fte5) + sum(sign(aoc()$Critical)*aoc()$fte5))
  
  rasa <-c(sum(aoc()$fte5),sum(sign(aoc()$Core)*aoc()$sray23),sum(sign(aoc()$Specialist)*aoc()$sray23),sum(sign(aoc()$Support)*aoc()$sray23),sum(sign(aoc()$Critical)*aoc()$sray23),       nma)
  revenue <-c(0, sum(sign(aoc()$Core)*aoc()$fte5),sum(sign(aoc()$Specialist)*aoc()$fte5),sum(sign(aoc()$Support)*aoc()$fte5),sum(sign(aoc()$Critical)*aoc()$fte5), nmf)
  revenue <-rasa-revenue
  cat=c(rep(c('0.Base','1.Core','2.Specialist','3.Support','4.Critical','5.Not Map'),1))
  ...
  col=c('rgba(1,1,1, 0.0)',"darkorange3", "midnightblue", "gold2", "deepskyblue2", "gray64")
  nmd =sum(aoc()$dds23)-(sum(sign(aoc()$Core)*aoc()$dds23) + sum(sign(aoc()$Specialist)*aoc()$dds23) + sum(sign(aoc()$Support)*aoc()$dds23) + sum(sign(aoc()$Critical)*aoc()$dds23))
  
  rasa <-c(sum(aoc()$fte5),sum(sign(aoc()$Core)*aoc()$dds23),sum(sign(aoc()$Specialist)*aoc()$dds23),sum(sign(aoc()$Support)*aoc()$dds23),sum(sign(aoc()$Critical)*aoc()$dds23), nmd)
  revenue <-c(0, sum(sign(aoc()$Core)*aoc()$fte5),sum(sign(aoc()$Specialist)*aoc()$fte5),sum(sign(aoc()$Support)*aoc()$fte5),sum(sign(aoc()$Critical)*aoc()$fte5), nmf)
  revenue <-rasa-revenue
  cat=c(rep(c('0.Base','1.Core','2.Specialist','3.Support','4.Critical','5.Not Map'),1))
  ...
  revenue <-c(sum(sign(aoc()$Core)*aoc()$dds23), sum(sign(aoc()$Specialist)*aoc()$dds23), sum(sign(aoc()$Support)*aoc()$dds23), sum(sign(aoc()$Critical)*aoc()$dds23), nmdd)
  cat=c(rep(c('1.Core','2.Specialist','3.Support','4.Critical','5.Not Map'),1))
  ...
  p<-plot_ly(data, x = ~x, y = ~revenue, type = 'bar',name='Demand',
    ...
    layout(title = 'Headcount', margin = list(b = 100),
           ...
           barmode = 'stack',
           showlegend = TRUE)%>%
    add_annotations(text = sum(aoc()$total), bgcolor='rgba(50, 50, 50, 1.0)',
                    x = '1.Current<br>headcount',
                    y = sum(aoc()$total)+2000,
                    xref = "x",
                    font = list(family = 'Arial',
                                size = 12,
                                color = 'rgba(50, 191, 1, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = sum(aoc()$addt),
                    x = '2.Upsizing',
                    y = sum(aoc()$total)+2000,
                    xref = "x",
                    font = list(family = 'Arial',
                    ...
                    showarrow = FALSE)%>%
    add_annotations(text = round(sum(aoc()$subt),0),
                    x = '3.Optimization',
                    y = sum(aoc()$total)-sum(aoc()$subt)+2000,
                    xref = "x",
                    font = list(family = 'Arial',
                                size = 12,
                                color = 'rgba(50, 1, 1, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(sum(aoc()$total)-sum(aoc()$subt),0),
                    x = '4.Y1 E',
                    y = sum(aoc()$total)-sum(aoc()$subt)+2000,
                    xref = "x",
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(50, 1, 1, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(sum(aoc()$total)-sum(aoc()$subt)-sum(aoc()$sray23),0),
                    ...
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(50, 1, 1, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(sum(aoc()$sray23)-sum(aoc()$fte5),0),
                    x = '6.Capability<br>Enhancement',
                    y = round(sum(aoc()$sray23),0)+2000,
                    xref = "x",
                    font = list(family = 'Arial',
                                size = 12,
                                color = 'rgba(50, 1, 1, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(sum(aoc()$dds23)-sum(aoc()$fte5),0),
                    x = '7.Business (R&M)',
                    y = round(sum(aoc()$dds23),0)+2000,
                    xref = "x",
                    font = list(family = 'Arial',
                                size = 12,
                                color = 'rgba(50, 1, 1, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(sum(aoc()$dds23),0),
                    x = '8.Y5 E',
                    y = round(sum(aoc()$dds23)+2000,0),
                    xref = "x",
                    font = list(family = 'Arial',
                                size = 12,
                                color = 'rgba(50, 1, 1, 1.0)'),
  ...
  p <-add_trace(p,
    ...
    add_annotations(text = sum(aoc()$total), bgcolor='rgba(50, 50, 50, 1.0)',
                    ...
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(50, 191, 1, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data0$revenue[1],0), bgcolor="darkorange3",bordercolor='rgba(255, 255, 255, 1.0)',
                    x = '1.Current<br>headcount',
                    y = data7$revenue[1]/2,
                    xref = "x",
                    font = list(family = 'Arial',
    ...
    add_annotations(text = round(data0$revenue[2],0),bgcolor="midnightblue",bordercolor='rgba(255, 255, 255, 1.0)',
                    ...
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(255, 255, 255, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data0$revenue[3],0), bgcolor="gold2",bordercolor='rgba(255, 255, 255, 1.0)',
                    x = '1.Current<br>headcount',
                    ...
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(255, 255, 255, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data0$revenue[4],0), bgcolor="deepskyblue2",bordercolor='rgba(255, 255, 255, 1.0)',
                    x = '1.Current<br>headcount',
                    ...
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(255, 255, 255, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data0$revenue[5],0), bgcolor="gray64",bordercolor='rgba(255, 255, 255, 1.0)', 
                    x = '1.Current<br>headcount',
  ...
  p <-add_trace(p,
    ...
    add_annotations(text =round( sum(aoc()$addt),0),
                    x = '2.Upsizing',
                    y = sum(aoc()$total)+2000,
                    xref = "x",
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(50, 1, 1, 1.0)'),
                    showarrow = FALSE)#%>%
    # add_annotations(text = round(data1$revenue[1],0), bgcolor="darkorange3",bordercolor='rgba(255, 255, 255, 1.0)',
    #                 x = '2.Upsizing',
    #                 y = data7$revenue[1]/2,
    #                 xref = "x",
    #                 font = list(family = 'Arial',
    ...
    #                             color = 'rgba(255, 255, 255, 1.0)'),
    #                 showarrow = FALSE)%>%
    # add_annotations(text = round(data1$revenue[3],0), bgcolor="gold2",bordercolor='rgba(255, 255, 255, 1.0)',
    #                 x = '2.Upsizing',
    #                 y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]/2,
    #                 xref = "x",
    #                 font = list(family = 'Arial',
    ...
    #                             color = 'rgba(255, 255, 255, 1.0)'),
    #                 showarrow = FALSE)%>%
    # add_annotations(text = round(data1$revenue[4],0), bgcolor="deepskyblue2",bordercolor='rgba(255, 255, 255, 1.0)',
    #                 x = '2.Upsizing',
    #                 y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]+data7$revenue[4]/2,
    #                 xref = "x",
    #                 font = list(family = 'Arial',
    ...
    #                             color = 'rgba(255, 255, 255, 1.0)'),
    #                 showarrow = FALSE)%>%
    # add_annotations(text = round(data1$revenue[5],0), bgcolor="gray64",bordercolor='rgba(255, 255, 255, 1.0)', 
    #                 x = '2.Upsizing',
    #                 y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]+data7$revenue[4]+data7$revenue[5]/2,
    #                 xref = "x",
    #                 font = list(family = 'Arial',
  ...
  p <-add_trace(p,
    ...
    add_annotations(text = round(sum(aoc()$subt),0),
                    ...
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(50, 1, 1, 1.0)'),
                     showarrow = FALSE)#%>%
    # add_annotations(text = round(data2$revenue[1],0), bgcolor="darkorange3",bordercolor='rgba(255, 255, 255, 1.0)',
    #                 x = '3.Optimization',
    #                 y = data7$revenue[1]/2,
    #                 xref = "x",
    #                 font = list(family = 'Arial',
    ...
    #                             color = 'rgba(255, 255, 255, 1.0)'),
    #                 showarrow = FALSE)%>%
    # add_annotations(text = round(data2$revenue[3],0), bgcolor="gold2",bordercolor='rgba(255, 255, 255, 1.0)',
    #                 x = '3.Optimization',
    #                 y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]/2,
    #                 xref = "x",
    #                 font = list(family = 'Arial',
    ...
    #                             color = 'rgba(255, 255, 255, 1.0)'),
    #                 showarrow = FALSE)%>%
    # add_annotations(text = round(data2$revenue[4],0), bgcolor="deepskyblue2",bordercolor='rgba(255, 255, 255, 1.0)',
    #                 x = '3.Optimization',
    #                 y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]+data7$revenue[4]/2,
    #                 xref = "x",
    #                 font = list(family = 'Arial',
    ...
    #                             color = 'rgba(255, 255, 255, 1.0)'),
    #                 showarrow = FALSE)%>%
    # add_annotations(text = round(data2$revenue[5],0), bgcolor="gray64",bordercolor='rgba(255, 255, 255, 1.0)', 
    #                 x = '3.Optimization',
    #                 y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]+data7$revenue[4]+data7$revenue[5]/2,
    #                 xref = "x",
    #                 font = list(family = 'Arial',
  ...
  p <-add_trace(p,
    ...
    add_annotations(text = round(sum(data3$revenue),0),
                    x = '4.Y1 E',
                    y = sum(aoc()$total)-sum(aoc()$subt)+2000,
                    xref = "x",
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(50, 1, 1, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data3$revenue[1],0), bgcolor="darkorange3",bordercolor='rgba(255, 255, 255, 1.0)',
                    x = '4.Y1 E',
                    y = data7$revenue[1]/2,
                    xref = "x",
                    font = list(family = 'Arial',
    ...
    add_annotations(text = round(data3$revenue[2],0),bgcolor="midnightblue",bordercolor='rgba(255, 255, 255, 1.0)',
                    ...
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(255, 255, 255, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data3$revenue[3],0), bgcolor="gold2",bordercolor='rgba(255, 255, 255, 1.0)',
                    x = '4.Y1 E',
                    y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]/2,
                    xref = "x",
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(255, 255, 255, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data3$revenue[4],0), bgcolor="deepskyblue2",bordercolor='rgba(255, 255, 255, 1.0)',
                    x = '4.Y1 E',
                    y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]+data7$revenue[4]/2,
                    xref = "x",
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(255, 255, 255, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data3$revenue[5],0), bgcolor="gray64",bordercolor='rgba(255, 255, 255, 1.0)', 
                    x = '4.Y1 E',
                    y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]+data7$revenue[4]+data7$revenue[5]/2,
                    xref = "x",
                    font = list(family = 'Arial',
  ...
  p <-add_trace(p,
    ...
    add_annotations(text = round(sum(data4$revenue[-1]),0),
                    x = '5.Automation<br>Reduction',
                    y = sum(aoc()$total)+2000,
                    xref = "x",
                    font = list(family = 'Arial',
  ...
  p <-add_trace(p,
    ...
    add_annotations(text = round(sum(aoc()$dds23),0),
                    ...
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(50, 1, 1, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data7$revenue[1],0), bgcolor="darkorange3",bordercolor='rgba(255, 255, 255, 1.0)',
                    x = '8.Y5 E',
                    y = data7$revenue[1]/2,
                    xref = "x",
                    font = list(family = 'Arial',
    ...
    add_annotations(text = round(data7$revenue[2],0),bgcolor="midnightblue",bordercolor='rgba(255, 255, 255, 1.0)',
                    ...
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(255, 255, 255, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data7$revenue[3],0), bgcolor="gold2",bordercolor='rgba(255, 255, 255, 1.0)',
                    x = '8.Y5 E',
                    y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]/2,
                    xref = "x",
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(255, 255, 255, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data7$revenue[4],0), bgcolor="deepskyblue2",bordercolor='rgba(255, 255, 255, 1.0)',
                    x = '8.Y5 E',
                    y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]+data7$revenue[4]/2,
                    xref = "x",
                    font = list(family = 'Arial',
                                ...
                                color = 'rgba(255, 255, 255, 1.0)'),
                    showarrow = FALSE)%>%
    add_annotations(text = round(data7$revenue[5],0), bgcolor="gray64",bordercolor='rgba(255, 255, 255, 1.0)', 
                    x = '8.Y5 E',
                    y = data7$revenue[1]+data7$revenue[2]+data7$revenue[3]+data7$revenue[4]+data7$revenue[5]/2,
                    xref = "x",
                    font = list(family = 'Arial',
  ...
  p <-add_lines(p, x=c('1.Current<br>headcount','2.Upsizing') , y= c(sum(data0$revenue), sum(data0$revenue)), name = "",
                line = list(color= 'black', widthh=0.7, dash="dash"), showlegend=FALSE)
  ...
  p <-add_lines(p, x=c('3.Optimization','4.Y1 E') , y= c(sum(data3$revenue), sum(data3$revenue)), name = "",
                line = list(color= 'black', widthh=0.7, dash="dash"), showlegend=FALSE)
  p <-add_lines(p, x=c('4.Y1 E','5.Automation<br>Reduction') , y= c(sum(data3$revenue), sum(data3$revenue)), name = "",
                line = list(color= 'black', widthh=0.7, dash="dash"), showlegend=FALSE)
  p <-add_lines(p, x=c('5.Automation<br>Reduction','6.Capability<br>Enhancement') , y= c(sum(data4$revenue), sum(data4$revenue)), name = "",
                line = list(color= 'black', widthh=0.7, dash="dash"), showlegend=FALSE)
  p <-add_lines(p, x=c('6.Capability<br>Enhancement','7.Business (R&M)') , y= c(sum(data5$revenue), sum(data5$revenue)), name = "",
                line = list(color= 'black', widthh=0.1, dash="dash"), showlegend=FALSE)
  p <-add_lines(p, x=c('7.Business (R&M)','8.Y5 E') , y= c(sum(data7$revenue), sum(data7$revenue)), name = "",
                line = list(color= 'black', widthh=0.3, dash="dash"), showlegend=FALSE)
  ...
  output$plot33<- renderPlotly({
    ...
    plot_ly(data, x = ~x, y = ~As_is, type = 'bar',name='As is', marker = list(color = 'rgba(191, 191, 191, 1)'))%>%
      add_trace(y = ~Opt,name='Optimistic', marker = list(color = 'rgba(227, 82, 5, 1)')) %>%
      add_trace(y = ~Con,name='Conservative', marker = list(color = 'rgba(0, 159, 223, 1)'))%>%
      layout(title = '',
             xaxis = list(title = ""),
             yaxis = list(title = ""))%>%
      add_annotations(text = round(Con,0),xshift=23,xanchor='left',
                      x = x,
                      y = Con*(1+1/40),
                      xref = "x",
                      font = list(family = 'Arial',
                                  ...
                                  color = 'rgba(50, 1, 1, 1.0)'),
                      showarrow = FALSE)%>%
      add_annotations(text = round(Opt,0),
                      x = x,
                      y = Opt*(1+2/40),
                      xref = "x",
                      font = list(family = 'Arial',
                      ...
                      showarrow = FALSE)%>%
      add_annotations(text = round(As_is,0),xanchor='right',xshift=-23,
                      x = x,
                      y = As_is*(1+3/40),
                      xref = "x",
                      font = list(family = 'Arial',
  ...
  output$plot34<- renderPlotly({
    ...
    x <- c(rep(c('Y1 E Demand','Y2 E Demand','Y3 E Demand','Y4 E Demand','Y5 E Demand'),5),rep(c('Y1 E Supply','Y2 E Supply','Y3 E Supply','Y4 E Supply','Y5 E Supply'),5))
  ...
  output$plot421<- renderPlotly({
    ...
    x <- c(sum(rs$Core),sum(rs$Critical0),sum(rs$Support),sum(rs$Specialist), sum(rs$not_map))#sum(rs$total)-sum(rs$Core)-sum(rs$Critical0)-sum(rs$Support)-sum(rs$Specialist))
  ...
  output$plot424<- renderPlotly({
    ...
    data <- data.frame(x, base, text)
    #The default order will be alphabetized unless specified as below:
    plot_ly(data, x = ~x, y = ~base, type = 'bar', orientation = 'h',marker = list(color = 'rgba(55, 128, 191, 0.7)'),hoverinfo = 'text', text = ~paste(base, text))%>%
  ...
  newEntry1 <- observe(vals$Data <- mutate(vals$Data,
                                           M_NHR= case_when(Region == "MEA" ~ input$t2skm1,  Region == "APAC" ~ input$t2skm1,
                                                            
                                                            Region == "AMR" ~ input$t2skm1, Region == "EUR" ~ input$t2skm1)
